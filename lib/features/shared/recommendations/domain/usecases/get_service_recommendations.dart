...
/// Use case for getting service recommendations
class GetServiceRecommendations {
  final RecommendationRepository repository;

  GetServiceRecommendations(this.repository);
  ...
  Future<Either<Failure, List<RecommendationEntity>>> call({
    ...
    return await repository.getServiceRecommendations(
